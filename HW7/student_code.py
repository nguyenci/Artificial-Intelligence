...
class LeNet(nn.Module):
    def __init__(self, input_shape=(32, 32), num_classes=100):
        ...
        self.fc1 = nn.Linear(400, 256)  # 16 * 5 * 5 = 400
...
def count_model_params():
    ...
    for name, parameter in model.named_parameters():  # loop over all the parameters
    ...
    return model_params  # return the number of trainable parameters in millions
